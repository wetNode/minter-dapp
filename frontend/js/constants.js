const contractAddress = "0x303A4689b5103f729AD38179b0FD5BFeE3E70B36"; // Replace with your own contract address
const chain = "rinkeby"; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the Ewa Oju NFT Project!!";

const welcome_h2 = "Connect MetaMask to get started";

const welcome_p =
  "The Ewa Oju NFT Project is a decentralized, open-source project that aims to express the uniquesness and beauty of individual's eyes. This is just a sample project on the Rinkeby network. We intend to perfect it and release it on the mainnet soonest. Join us today!";
